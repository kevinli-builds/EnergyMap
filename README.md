...
Done: clustered multi-tech map, status/capacity filters, legend, featured panel + **tour**,
project **detail drawer** with shareable `?p=<slug>` **deep links**, a **Jobs tab** with live
open-role counts, in-view **stats + country breakdown**, **country energy-mix panel** (green vs
fossil + report links), **transmission/interconnector lines**, collapsible mobile HUD, first-visit
intro, GEM solar/wind import, nightly job refresh, static export.
